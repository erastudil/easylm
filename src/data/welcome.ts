...
All tokens and model generations run directly on **your GPU** via WebGPU. No accounts. No subscriptions. Optional Hands send the lookup you asked for. The official app is free forever. GNU AGPL-3.0.
