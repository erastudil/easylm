---
title: "history — undergrad textbook"
date: "2026-09-13"
...
History is not the memorization of arbitrary chronologies; it is the forensic, disciplined reconstruction of past human societies from surviving material and textual traces. The past itself has vanished; what remains are physical artifacts, diplomatic treaties, tax rolls, cuneiform tablets, and oral lineages. Historiography applies critical scrutiny to these fragments: asking who created the record, under what material constraints, for what audience, and what systemic biases distort the archive.

```
+---------------------------------------------------------------------------------------------------+
|                                 THE HISTORICAL ARCHITECTURE                                       |
+---------------------------------------------------------------------------------------------------+
|  EPISTEMOLOGY (Historiography)    | Primary vs Secondary Sources · Provenance · Hermeneutics      |
+-----------------------------------+---------------------------------------------------------------+
|  CHRONOLOGY (Temporal Framing)    | Calendars · Periodization · Annales Longue Durée · Contingency |
+-----------------------------------+---------------------------------------------------------------+
|  NEOLITHIC REVOLUTION (Sedentism) | Domestication Bottlenecks · Surplus Storage · Demographic Rise|
+-----------------------------------+---------------------------------------------------------------+
|  URBAN CORES & STATES (Writing)   | Hydraulic Empires · Cuneiform / Hieroglyphs · Legal Codes     |
+-----------------------------------+---------------------------------------------------------------+
|  TRADE & BELIEF NETWORKS (Axes)   | Silk Roads · Indian Ocean Monsoon Routes · Trans-Saharan Gold  |
+-----------------------------------+---------------------------------------------------------------+
|  OCEANIC CONVERGENCE (1492)       | Columbian Exchange · Silver Flows · Plantation Chattel Slavery |
+-----------------------------------+---------------------------------------------------------------+
|  INDUSTRIAL TRANSFORMATION (Coal) | Fossil Energy Regimes · Steam Mechanics · Urban Proletariats  |
+-----------------------------------+---------------------------------------------------------------+
