...
summary: "sovereign browser engine modules: webllm, memory, crypto vault, math, stacks, export, storage."
...
2. **deterministic hands** : tools, math, SSRF fences, and vault functions stay deterministic.
