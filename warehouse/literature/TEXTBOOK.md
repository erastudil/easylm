---
title: "literature — undergrad textbook"
date: "2026-09-13"
status: living · easylm
home: "warehouse/literature/"
related:
  - "../philosophy/"
  - "../history/"
  - "../geography/"
...
# literature — undergrad textbook

a working book for tongues, desks, and humans who must **name the genre, the speaker, and a fair reading**.  
this file teaches. a plot, a quoted sentence, a date of a text → DONT_KNOW / fetch the page. **no invented plot. no fake quote.**

**hard rule for EasyLM:** verbatim literature (a line of verse, a sentence of prose, a stage speech) is a **fetch**. use web search / the named corpus (Folger, Perseus, Gutenberg, ctext, Aozora). do not finish a quotation from memory. a remembered line is a forgery.

**law this book applies:** genre first (the contract). narrator ≠ author unless the page says so. criticism is a claim plus a passage. rhetoric is how speech moves someone. place of a language literature is `../geography/`. of which thou knowest not, remain silent.

this pack owns **stories and arguments in language**, including verse as a working unit of the **line**. value talk: `../philosophy/`. when a text sat: `../history/`.
...
| genre as contract | 2 |
| prose, verse, drama | 3 |
| narrative (story vs telling) | 4 |
| narrator, person, focalization | 5 |
| character, setting, time | 6 |
| short story and novel | 7 |
| drama | 8 |
| epic and long verse | 9 |
| essay and nonfiction | 10 |
| rhetoric triad | 11 |
| figures that do work | 11b |
| close reading | 12 |
| criticism as argument | 13 |
| how to cite a text | 14 |
| translation, canon, world | 15 |
| Folger, Perseus, Yale ENGL 300 | 16 |
| stuck on a text | 17 |

work order: **why → what → how**. name the genre before you name a theme.
...
```
CITE: warehouse/literature/TEXTBOOK.md
```
